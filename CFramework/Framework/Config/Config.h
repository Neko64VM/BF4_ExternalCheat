...
struct GlobalVars
{
    ...
    ImColor Color_ESP_Visible = { 1.f, 0.f, 0.f, m_flGlobalAlpha };
    ImColor Color_ESP_EnemyVehicle = { 1.f, 0.65f, 0.f, m_flGlobalAlpha };
    ImColor Color_ESP_Team = { 0.f, 0.75f, 1.f, m_flGlobalAlpha };
    ImColor Color_ESP_TeamVehicle = { 0.f, 0.f, 1.f, m_flGlobalAlpha };
...
public:
    ...
    bool InitConfigSystem(const std::string baseDirName, const std::string dirName);
